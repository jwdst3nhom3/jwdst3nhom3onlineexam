    ...
    <div class="main">
      <div class="thongtin">
        <div class="jumbotron">
          ...
          <h4>Mã số đề thi: CHCS_N1</h4>
          <h4>Teacher: Trang Tran Trien</h4>
          <h4>Thời gian làm bài: 60 phút</h4>
          <h4>Thời hạn làm bài: 24:00 18/9/2016 - 1:00 19/9/2016</h4>
          <div class="sua">
            <a href="A3.jsp">
            <button class="button" >Mở bài thi</button>
            </a>
            <a href="A1.jsp">
            <button  class="button" >Đóng bài thi</button>
            </a>
          </div>
        </div>
      </div>
