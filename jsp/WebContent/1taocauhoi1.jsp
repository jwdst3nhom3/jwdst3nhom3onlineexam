        ...
        <div class="jumbotron">
          <table>
            <tr>
              <td>Mã Đề: </td>
              <td>
                <input class="button" type="text" name="Made" id="ma">
              </td>
            </tr>
            <tr>
              <td>Tựa đề:</td>
              <td>
                <input class="button" type="text" name="Tuade" id="tua">
              </td>
            </tr>
            <tr>
              <td> Thời gian làm bài (Phút):</td>
              <td>
                <input class="button" type="text" name="Thoigian" id="thoigian">
              </td>
            </tr>
            <tr>
              <td> Lĩnh Vực:</td>
              <td>
                <select class="button" name="linhvuc">
                  ...
                  <option value="chinhtrii">Chính trị</option>
            ...
            <tr>
              <td> Số Lượng Câu:</td>
              <td>
                <select class="button" name="soluong">
