...
<section>
  <div class="Left">
    <ul class="list-group">
      ...
      <li>
        <a href="TaoLinhVucMoi" class="list-group-item">
        Tạo lĩnh vực mới
        </a>
      </li>
    </ul>
      ...
      <div class="Main_content">
        ...
        <div class="Mid_Main_content">
          <div class="Text_Mid_Main_content">
            ...
            <textarea class="Input_Text_Mid">Nếu A...Z </textarea>
          </div>
          <div class="Text_Mid_Main_content">
            <div class="Input_Text_Mid_Main_content">Đáp án 1 : </div>
            <input type="text" class="Input_Text_Mid_Main_content" value="A" />
          </div>
          <div class="Text_Mid_Main_content">
            <div class="Input_Text_Mid_Main_content">Đáp án 2 : </div>
            <input type="text" class="Input_Text_Mid_Main_content" value="B" />
          </div>
          <div class="Text_Mid_Main_content">
            <div class="Input_Text_Mid_Main_content">Đáp án 3 : </div>
            <input type="text" class="Input_Text_Mid_Main_content" value="C" />
          </div>
          <div class="Text_Mid_Main_content">
            <div class="Input_Text_Mid_Main_content">Đáp án 4 : </div>
            <input type="text" class="Input_Text_Mid_Main_content" value="D" />
          </div>
          <div class="Text_Mid_Main_content">
        ...
        <div class="Bottom_Main_content_Taocauhoi">
          <a href="CauHoi.jsp">
          <button class="Left_btn">Sửa</button>
          </a>
          <a href="CauHoi.jsp">
