...
<link rel="stylesheet" type="text/css" href="css/KetThuc.css"/>
</head>
...
<section>
  ...
  <div class="container">
    <div class="main">
<div class="end">
        <div class="top-end">Bài Thu Hoạch Chính Trị 2016-2017</div>
        <div class="mid-end">Chúc mừng bạn đã hoàn thành bài thi của mình. Bạn có chắc không?</div>
        <div class="bottom-end"> <a href="Diem.jsp">
